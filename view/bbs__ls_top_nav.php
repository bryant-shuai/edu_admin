...
?>
        ...
        <div id="bbs_header" style="background:#F1F1F1;margin:0px;padding:10px 0 10px 0;position:fixed;width:100%;z-index:999;">
...
<div class="swipe-content content-list" style="position:relative;width:100%;overflow-x:hidden;padding-top:70px;">
