...
<template id="vue_news_comment_list">
  ...
  <div v-for="item in ls" class="pinglun">
    <img src="{{members[item.member_id].avatar}}" class="avatar" onerror="this.onerror=null;this.src='/app/noavatar_big.gif'" />

    <div class="pl-content">
        <div class="pl-head">
            <div class="pl-date">{{members[item.member_id].name}} &nbsp;{{item.create_at}}</div>
            <div class="pl-floor">                                
  ...
  <div v-if="autoload || firstload || 0">
    <div v-if="!no_more || firstload || 0">
      ...
      <div>
        ...
        <div class="dropload-down" style="text-align:center;-webkit-transform: scale(0.4);transform: scale(0.4);">
